...
void loop(void)
{
    ...
    for (int i = 0; i < Text.length(); i++){
      if (Text[i] != OldText[i]) tft.fillRect(30 + 12 + i*106, 250, 80, -128, BLACK);
      tft.drawChar(30 + i*106, 250, Text[i], WHITE, BLACK, 2);
    }
    OldText = Text;
    delay (2000);
...
/*    tft.setCursor(30, 250);
    ...
    for (int i = 0; i < 4; i++){
      ...
      tft.fillRect(30 + 12 + i*106 + (i>2)*2 , 250, 80, -128, BLACK);
    }
