...
//#include <SD.h>
#include <c:\Program Files\Arduino\libraries\WiFi\extras\wifiHD\src\SOFTWARE_FRAMEWORK\DRIVERS\SPI\SPI.h>


#include <c:\Program Files\Arduino\libraries\SdFat-master\src\SdFatConfig.h>
#ifndef SdFat_h
  #include <c:\Program Files\Arduino\libraries\SdFat-master\src\SdFat.h>
#endif
#ifndef SdFatConfig_h
  #error SdFatConfig.h not includet
#endif
#ifndef SdFat_h
  #error SdFat.h not includet
#endif

#include <c:\Program Files\Arduino\libraries\LCDWIKI_GUI\LCDWIKI_GUI.h> //Core graphics library
#include <c:\Program Files\Arduino\libraries\LCDWIKI_KBV\LCDWIKI_KBV.h> //Hardware-specific library

#warning Message from Compiler
#pragma "message Gtxfnm"
...
void loop() 
{
    ...
    for(i = 0;i<FILE_NUMBER;i++)
    {
        ...
        if (!file.open(file_name[i], O_RDWR)) {
//        }
