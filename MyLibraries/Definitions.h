...
#define SCALE_DELAY_TIME      5000        // время задержки измерения веса после пневмоподачи
...
#define SOFT_MISO_PIN         12 // SD на мониторе
#define SOFT_SCK_PIN          13 // SD на мониторе
#define SOFT_CS_PIN           10 // SD на мониторе
//#define SHAKE_HSD_PIN         27 //включение/выключение питания на внешний SD - устарело
#define RTC_SDA_PIN           20 //Часы
#define RTC_SCL_PIN           21

#define LOADCELL_DOUT_PIN     33 // Тензодатчик
#define LOADCELL_SCK_PIN      35 // Тензодатчик
...
#define HSD_POWER_PIN         47 // включение/выключение питания на внешний SD - реле 2
...
// Развешиватель
#define WATCH_PIN_OUT         27 // идет на 7 пин нано
//#define WATCH_PIN_IN          25 // идет на 8 пин нано - пока не подключено
