...
//                    ShakeSD
//********************************************************
void ShakeSD(uint8_t Shake_Pin){
...
//--------------------------------------------------------
  ...
  while (SoftFile.available()) HardFile.write(SoftFile.read());
  return "Done";
